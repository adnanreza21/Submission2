package com.amazing.submission2.Adapter;
...
import com.amazing.submission2.TVShowDetailActivity;
...
public class CardViewTvShowAdapter extends RecyclerView.Adapter<CardViewTvShowAdapter.CardViewViewHolder> {
    ...
    public CardViewViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_card_view_tv_show, viewGroup, false);
